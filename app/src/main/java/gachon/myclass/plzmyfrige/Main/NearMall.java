...
public class NearMall extends AppCompatActivity
    ...
    private static final String TAG = "find market";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nearmall);
        ...
        mLayout = findViewById(R.id.layout_nearmall);
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions(NearMall.this, REQUIRED_PERMISSIONS,
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(NearMall.this);
